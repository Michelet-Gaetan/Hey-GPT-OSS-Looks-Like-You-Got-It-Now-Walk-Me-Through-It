...
if __name__=="__main__":
	...
	base_paths = ["./data_redo/suspicious-message-detection","./data_redo/methodology-generation"]
	tasks_roles_prompts = []
	...
	for base_path in base_paths:
		...
		with open(f"output/final/redo/prompt_{task}.txt","w",encoding='utf-8') as f:
	...
	temperatures=[0.7]
	iterations = 4
	file_path = "output/final/redo/output"
